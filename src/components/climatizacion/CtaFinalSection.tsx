...
export default function CtaFinalSection({}: CtaFinalSectionProps) {
  ...
  return (
    <section className="bg-white text-center py-[88px] px-16 border-t border-gray-200">
      ...
      <button onClick={() => scrollTo("contacto")} className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#2ebd6b] hover:bg-[#1a9e54] text-white text-sm font-bold rounded-md transition-colors duration-200 cursor-pointer border-none">
